...
<script>
  window.defaultUrl = `{{ url('/report_laundry/') }}/`;

  $(document).ready(function() {
    $('.select2').select2({
      dropdownParent: $('#laundryForm'),
      allowClear: true,
      width: '78%',
      placeholder: ''
    });
  ...
  function cetakPdf() {
      ...
      var params = $("#laundryForm").serializeArray();
      var params = $.param(params);

      if (jenis_lap == 1) {
        window.open(defaultUrl + "createPdfRekapLaundryPerBulan?" + params);
