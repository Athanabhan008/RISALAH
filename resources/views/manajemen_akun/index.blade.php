            ...
            <div class="card-header pb-0">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center;">
                  <div class="ml-auto">
                      ...
                      <button type="button" class="btn btn-info" id="btn-password">
              ...
              <div class="table-responsive p-0">
                <table id="datatable" class="table table-striped table-bordered basic-datatables">
                    <thead style="background-color: #1E3135;">
                      <tr>
                        <th class="text-uppercase text-light text-center text-xxs font-weight-bolder opacity-7">#</th>
                        <th class="text-uppercase text-light text-center text-xxs font-weight-bolder opacity-7 ps-2">Nama User</th>
                        <th class="text-center text-uppercase text-light text-center text-xxs font-weight-bolder opacity-7">Email</th>
                        <th class="text-center text-uppercase text-light text-center text-xxs font-weight-bolder opacity-7">Role</th>
                      </tr>
                    </thead>
                    <tbody></tbody>
                  </table>
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" style="width: 100px; height: 35px; background-color: rgb(222, 222, 222);">Username</span>
                        </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" style="width: 100px; height: 35px; background-color: rgb(222, 222, 222);">Email</span>
                        </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" style="width: 100px; height: 35px; background-color: rgb(222, 222, 222);">Password</span>
                        </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" style="width: 100px; height: 35px; background-color: rgb(222, 222, 222);">Role</span>
                        </div>
...
<script>
window.defaultUrl = `{{ url('/manajemen_akun/') }}/`;
...
$(document).ready(function() {
    ...
    $("#btn-edit").on("click", function () {
        ...
        modal.find("input[name=role]").val(selected.role);
...
function viewDatatable() {
    table = $(".basic-datatables").DataTable({
        ajax: {
            url: "{{ route('manajemenakun/datatable') }}",
            "type": "post",
            "data": function (d) {
