                    ...
                    <form class="p-3" id="barangForm">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-12 col-md-12">
                                ...
                                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 90px; font-weight: bold; background-color: #AAB99A; width: auto;">Nama Kategori</span>
                                <input type="text" class="form-control" name="nama_kategori" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                                  </div>
                            </div>
                        </div>
...
function doSave() {
    $.ajax({
        type: 'POST',
        url: "{{ route('kategori_barang/dosave') }}",
