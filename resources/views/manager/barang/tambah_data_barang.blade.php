                    ...
                    <form class="p-3" id="barangForm">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="form-group col-12 col-md-12">
                                ...
                                <input type="text" class="form-control" name="nama_barang" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                                  </div>
                            </div>
                            {{-- <div class="form-group col-12 col-md-12">
                                <div class="input-group input-group-sm mb-3">
                            ...
                            <div class="form-group col-12 col-md-12">
                                ...
                                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 90px; font-weight: bold; background-color: #AAB99A; width: auto;">Harga</span>
                                   <input type="text" class="form-control" name="harga" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                                  </div>
                            </div>
                            <div class="form-group col-12 col-md-12">
                                <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 90px; font-weight: bold; background-color: #AAB99A; width: auto;">Tanggal Masuk</span>
                                   <input id="datepicker" type="text" class="form-control" name="tanggal_masuk" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                                  </div>
                            </div>
                        </div>
                        <button type="button" onclick="doSave();" class="btn btn-success mt-4">Submit</button>
...
function doSave() {
    $.ajax({
        ...
        error: function(xhr) {
            console.error("Error: ", xhr); // Debugging
