...
$(document).ready(function() {
    ...
    $("#btn-detail").on("click", function () {
        ...
        window.location.href = defaultUrl + "detail_data_non_ppn?id_non_ppn=" + selected.id;
...
function generateNomorPR() {
    $.ajax({
        url: '{{ route("non_ppn.generate_nomor_pr") }}',
        type: 'GET',
        dataType: 'json',
        success: function(response) {
            if (response.success) {
