@extends('layouts.laundry.template_laundry')
              ...
              <div class="table-responsive p-0">
                <table id="datatable" class="table table-striped table-bordered basic-datatables">
                    <thead style="background-color: #1E3135; color: white;">
                      <tr>
                        <th style="color: white;" class="text-uppercase text-xxs font-weight-bolder opacity-7">No Sound</th>
                        <th style="color: white;" class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">Tgl Booking</th>
                        <th style="color: white;" class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">Nama Paket</th>
                        <th style="color: white;" class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">Nama Client</th>
                        <th style="color: white;" class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">Total Harga</th>
                      </tr>
                    </thead>
                    <tbody></tbody>
                  </table>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Form - Data Laundry</h5>
        ...
        <div class="modal-body">
            <form id="form_sound">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" style="width: 120px; height: 35px; background-color: rgb(222, 222, 222);">Tgl Booking</span>
                        </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" style="width: 120px; background-color: rgb(222, 222, 222);">Nama Paket</span>
                        </div>
                        <select name="cmb_sound" id="cmb_sound"></select>
                    </div>

                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" style="width: 120px; height: 35px; background-color: rgb(222, 222, 222);">Total Harga</span>
                        </div>
                        <input type="number" name="total_harga" id="total_harga" class="form-control" style="border: 1px solid black;" readonly>
                    </div>
...
$(document).ready(function() {
    ...
    // Add click handler for Tambah Data button
    $('button[data-target="#formModal"]').on('click', function() {
        // Reset form
        $('#form_sound')[0].reset();

        // Reset select2
        $('select[name=cmb_sound]').val(null).trigger('change');
    ...
    $('select[name=cmb_sound').on('select2:select', function (e) {
...
function koleksiSelect2() {
    $('select[name=cmb_sound]').select2({
        dropdownParent: $('#formModal'),
        allowClear: true,
        width: '72%',
        // height: '35px',
        placeholder: 'Pilih Paket Sound',
        ajax: {
            url: "{{ url('/sound/getpaketsound') }}",
            dataType: 'json',
